...
const { checkAuthorisation } = require('../middleware/test');
...
router.post('/signup', async (req, res) => {
  ...
  try {
    const user = await User.create({ name, email, password: sha256(req.body.password) });
